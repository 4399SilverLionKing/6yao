import { FIVE_ELEMENT_CONTROLS, FIVE_ELEMENT_GENERATES, RELATION_LABELS } from "../../data/zengshan/relations";
...
export function getFormalSixRelations(hexagram: HexagramInstance, naJiaLines: NaJiaLine[]) {
